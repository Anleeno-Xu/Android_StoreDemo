...
/**
 * Created by Anleeno on 2019/2/22.
 */

public class Book implements Serializable {
    private String bk_ISBN;//ISBN码
    private String bk_name;//书名
    private String bk_author;//作者
    private String bk_picuri;//封面
    private String bk_press;//出版社
    private String bk_detail;//简介
    private double bk_price;//价格
